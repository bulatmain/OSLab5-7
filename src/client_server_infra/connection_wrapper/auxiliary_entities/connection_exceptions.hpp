...
namespace lab5_7 {
    ...
    class AttemptToRecvMsgWithNotBindedSocketException : public ConnectionException {
    public:
        AttemptToRecvMsgWithNotBindedSocketException() noexcept
            : ConnectionException("Error: attempt to recieve message with not binded socket") {}
    };
